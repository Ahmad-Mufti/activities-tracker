...
import { Calendar, ListTodo, Repeat, RotateCcw, MapPin, Clock, Sunrise, CalendarClock } from 'lucide-react'
import { supabase } from '../supabaseClient'
import { useAuth } from '../context/AuthContext'
import { useSemesters } from '../context/SemesterContext'
import { todayLocalISO, addDays, isoDayOfWeek } from '../lib/dates'
import { computePrayerTimes, getNextPrayer, formatTime, PRAYER_LABELS, PRAYER_ORDER } from '../lib/prayerTimes'
...
export default function Dashboard() {
  ...
  const fetchDashboard = useCallback(async () => {
    ...
    setDueTasks(Array.from(merged.values()))
  ...
  useEffect(() => {
    if (!user) return
    const tables = ['courses', 'events', 'tasks', 'habits', 'habit_logs', 'hafalan_plans', 'hafalan_units', 'user_settings']
