...
// Daftar catatan inbox belum dipilah + aksi pilah/hapus. Dipakai di halaman Inbox
// dan di langkah 1 Weekly Review (Fase 12) — logikanya sama persis di kedua tempat.
export default function InboxList({ emptyMessage = 'Inbox kosong. Semua catatan sudah dipilah. 🎉' }) {
  const { user } = useAuth()
  ...
  return (
    <div>
      <div className="space-y-2">
        {items.length === 0 && <p className="text-gray-400">{emptyMessage}</p>}
        {items.map((item) => (
